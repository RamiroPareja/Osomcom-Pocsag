...
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/source/eeprom.p1 ${OBJECTDIR}/source/main.p1 ${OBJECTDIR}/source/rs232.p1 ${OBJECTDIR}/source/tools.p1 ${OBJECTDIR}/source/spi.p1 ${OBJECTDIR}/source/adf7012.p1 ${OBJECTDIR}/source/pocsag.p1 ${OBJECTDIR}/source/pocsagPhy.p1 ${OBJECTDIR}/source/interrupts.p1 ${OBJECTDIR}/source/io.p1 ${OBJECTDIR}/source/config.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/source/eeprom.p1.d ${OBJECTDIR}/source/main.p1.d ${OBJECTDIR}/source/rs232.p1.d ${OBJECTDIR}/source/tools.p1.d ${OBJECTDIR}/source/spi.p1.d ${OBJECTDIR}/source/adf7012.p1.d ${OBJECTDIR}/source/pocsag.p1.d ${OBJECTDIR}/source/pocsagPhy.p1.d ${OBJECTDIR}/source/interrupts.p1.d ${OBJECTDIR}/source/io.p1.d ${OBJECTDIR}/source/config.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/source/eeprom.p1 ${OBJECTDIR}/source/main.p1 ${OBJECTDIR}/source/rs232.p1 ${OBJECTDIR}/source/tools.p1 ${OBJECTDIR}/source/spi.p1 ${OBJECTDIR}/source/adf7012.p1 ${OBJECTDIR}/source/pocsag.p1 ${OBJECTDIR}/source/pocsagPhy.p1 ${OBJECTDIR}/source/interrupts.p1 ${OBJECTDIR}/source/io.p1 ${OBJECTDIR}/source/config.p1
...
dist/${CND_CONF}/${IMAGE_TYPE}/Osomcom_POCSAG.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G --asmlist -mdist/${CND_CONF}/${IMAGE_TYPE}/Osomcom_POCSAG.X.${IMAGE_TYPE}.map  -D__DEBUG=1 --debugger=pickit3  --double=24 --float=24 --emi=wordwrite --opt=default,+asm,-asmfile,+speed,-space,-debug --addrqual=ignore --mode=free -P -N255 --warn=0 --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib "--errformat=%f:%l: error: %s" "--warnformat=%f:%l: warning: %s" "--msgformat=%f:%l: advisory: %s"   --rom=default,-3e00-3fff   -odist/${CND_CONF}/${IMAGE_TYPE}/Osomcom_POCSAG.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/Osomcom_POCSAG.X.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/Osomcom_POCSAG.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G --asmlist -mdist/${CND_CONF}/${IMAGE_TYPE}/Osomcom_POCSAG.X.${IMAGE_TYPE}.map  --double=24 --float=24 --emi=wordwrite --opt=default,+asm,-asmfile,+speed,-space,-debug --addrqual=ignore --mode=free -P -N255 --warn=0 --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib "--errformat=%f:%l: error: %s" "--warnformat=%f:%l: warning: %s" "--msgformat=%f:%l: advisory: %s"   -odist/${CND_CONF}/${IMAGE_TYPE}/Osomcom_POCSAG.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
